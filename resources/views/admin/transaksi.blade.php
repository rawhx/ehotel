        ...
        <div class="isi">
            ...
            <div class="pp">
                <div class="judul-column">
                    ...
                    <div class="ehp"><h6  style="width: 250px">HOTEL</h6></div>
                    <div class="password"><h6  style="width: 250px">PEMESANAN</h6></div>
                    <div class="password"><h6  style="width: 250px">CHECK IN</h6></div>
                    <div class="password"><h6  style="width: 250px">CHECK OUT</h6></div>
                </div>
                <div class="xx">
                    ...
                    <div class="isi-column">
                        ...
                        <div class="password"><P style="width: 250px">11/12/2025</P></div>
                        <div class="password"><P style="width: 250px">11/12/2025</P></div>
                    </div>
                    @endforeach
                </div>
